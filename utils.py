...
#função de formatação de números para exibir a receita total e a quantidade de vendas de forma mais legível, utilizando sufixos como "mil" e "milhões" para valores grandes.
...
#2- Dataframe Receota Mensal
## Agrupa os dados por mês utilizando a coluna 'Data da Compra' como índice e calcula a soma da coluna 'Preço' para cada mês, resultando em um DataFrame que mostra a receita mensal.
...
##Função para converter arquivo para CSV
